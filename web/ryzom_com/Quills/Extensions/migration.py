...
##############################################################################
"""Handlers for migration scripts."""

from Products.Quills.migrations import quills08to09

from StringIO import StringIO

def migrate08to09(self):
    migration = quills08to09.Migration(site=self, out=StringIO())

    migration.migrate()

    return migration.out.getvalue()
