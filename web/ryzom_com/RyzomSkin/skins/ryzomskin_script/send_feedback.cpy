## Controller Python Script "send_feedback"
...
receiver = mtool.getMemberById(author)
author_id = "%s (%s)" % (receiver.getProperty('fullname'), receiver.getId())
...
try:
    ...
    resultcopy = host.secureSend("copy of message to "+author_id+" : "+message, send_from_address, envelope_from, subject="copy of message send to "+author_id+" : "+subject, subtype='plain', charset=encoding, debug=False, From=send_from_address)
