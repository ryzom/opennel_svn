...
# Original workflow id/title: WeblogArchive_workflow/WeblogArchive Workflow
# Date: 2006/05/05 12:43:46.283 GMT+2
#
...
def setupWeblogarchive_workflow(wf):
    "..."
    wf.setProperties(title='WeblogArchive Workflow')

    for s in ['visible', 'draft', 'public', 'private', 'published']:
        wf.states.addState(s)
    for t in ['retract', 'hide', 'draft', 'make_public', 'publish']:
    ...
    sdef.setPermission('List folder contents', 0, ['Editor', 'Manager', 'Owner'])
    ...
    sdef.setPermission('List folder contents', 0, ['Anonymous', 'Authenticated', 'Manager', 'Member', 'Owner', 'Reviewer'])
    ...
    sdef.setProperties(title="""Published""",
                       transitions=('hide', 'make_public', 'retract'))
    sdef.setPermission('Access contents information', 0, ['Anonymous', 'Authenticated', 'Manager', 'Member', 'Owner', 'Reviewer'])
    sdef.setPermission('Modify portal content', 0, ['Manager', 'Owner'])
    sdef.setPermission('View', 0, ['Anonymous', 'Authenticated', 'Manager', 'Member', 'Owner', 'Reviewer'])
    sdef.setPermission('List folder contents', 0, ['Anonymous', 'Authenticated', 'Manager', 'Member', 'Owner', 'Reviewer'])
    ...
    tdef.setProperties(title="""Member makes content draft""",
                       new_state_id="""draft""",
                       trigger_type=1,
                       script_name="""""",
                       after_script_name="""""",
...
def createWeblogarchive_workflow(id):
    "..."
    ob = DCWorkflowDefinition(id)
    setupWeblogarchive_workflow(ob)
    return ob

addWorkflowFactory(createWeblogarchive_workflow,
                   id='WeblogArchive_workflow',
                   title='WeblogArchive Workflow')
