...
# Original workflow id/title: folder_workflow/Folder Workflow
# Date: 2006/05/05 12:49:21.186 GMT+2
#
...
def setupFolder_workflow(wf):
    "..."
    wf.setProperties(title='Folder Workflow (ryzom)')

    for s in ['visible', 'draft', 'public', 'private', 'published']:
        wf.states.addState(s)
    for t in ['retract', 'draft', 'hide', 'make_public', 'publish']:
    ...
    sdef.setPermission('Access contents information', 0, ['Authenticated', 'Manager', 'Member', 'Owner', 'Reviewer'])
    sdef.setPermission('Modify portal content', 0, ['Manager', 'Owner'])
    sdef.setPermission('View', 0, ['Authenticated', 'Manager', 'Member', 'Owner', 'Reviewer'])
    sdef.setPermission('List folder contents', 0, ['Authenticated', 'Manager', 'Member', 'Owner', 'Reviewer'])
