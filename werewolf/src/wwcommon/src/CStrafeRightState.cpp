...
// Werewolf Includes
//
#include "ww/wwcommon/CStrafeRightState.h"
#include "ww/wwcommon/CStrafeState.h"
...
OF_REGISTER(CStateFactory, ISimulationState, CStrafeRightState, uint32, CStateFactory::ST_ST_RIGHT);

CStrafeRightState::CStrafeRightState() : CStrafeState(1) {
...
ISimulationState *CStrafeRightState::Create() {
	return new CStrafeRightState();
}
