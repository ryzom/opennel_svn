...
public:
	...
	typedef CHashMap<const char*, ISobController*, CHash<const char*>, streqpred> controllerMap;
	typedef CHashMap<const char*, IView*, CHash<const char*>, streqpred> viewMap;
