...
public:
	...
	// component specific
	NL3D::TGlobalAnimationTime AnimationTime; // old, use GlobalAnimationTime
	NL3D::TGlobalAnimationTime AnimationDelta; // old, use AnimationTimeDelta 
