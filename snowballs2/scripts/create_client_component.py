...
file = askVar("File", "empty_component").replace(" ", "_")
classname = askVar("Class", "CEmptyComponent")
...
hcode1 += [ "#include \"configurable_component.h\"" ]
hcode1 += [ "" ]
...
hcode2 = [ ]
hcode2 += [ "class {CLASS} : public IConfigurableComponent" ]
hcode2 += [ "{" ]
hcode2 += [ "protected:" ]
hcode2 += [ "	// pointers" ]
hcode2 += [ "	// ..." ]
...
hcode2 += [ "	// ..." ]
hcode2 += [ "public:" ]
hcode2 += [ "	{CLASS}(CComponentManager *manager, const std::string &instanceId, NLMISC::IProgressCallback &progressCallback);" ]
hcode2 += [ "	~{CLASS}();" ]
hcode2 += [ "	void update();" ]
hcode2 += [ "	void render();" ]
hcode2 += [ "	void config(const std::string &varName, NLMISC::CConfigFile::CVar &var);" ]
hcode2 += [ "	void componentUp(IComponent *component);" ]
hcode2 += [ "	void componentDown(IComponent *component);" ]
hcode2 += [ "}; /* class {CLASS} */" ]
hcode2 += [ "" ]
...
cppcode += [ "" ]
cppcode += [ "{CLASS}::{CLASS}(CComponentManager *manager, const string &instanceId, IProgressCallback &progressCallback)" ]
cppcode += [ "	: IConfigurableComponent(manager, instanceId, progressCallback)" ]
cppcode += [ "{" ]
cppcode += [ "	nlwarning(\"Unknown IComponent {CLASS}() call\");" ]
cppcode += [ "}" ]
cppcode += [ "" ]
cppcode += [ "{CLASS}::~{CLASS}()" ]
cppcode += [ "{" ]
...
cppcode += [ "}" ]
cppcode += [ "" ]
cppcode += [ "void {CLASS}::update()" ]
cppcode += [ "{" ]
cppcode += [ "	nlwarning(\"Unknown IComponent update() call\");" ]
cppcode += [ "}" ]
cppcode += [ "" ]
cppcode += [ "void {CLASS}::render()" ]
cppcode += [ "{" ]
cppcode += [ "	nlwarning(\"Unknown IComponent render() call\");" ]
cppcode += [ "}" ]
cppcode += [ "" ]
cppcode += [ "void {CLASS}::config(const string &varName, CConfigFile::CVar &var)" ]
cppcode += [ "{" ]
cppcode += [ "	nlwarning(\"Unknown IConfigurableComponent config(varName, var) call\");" ]
cppcode += [ "}" ]
cppcode += [ "" ]
cppcode += [ "void {CLASS}::componentUp(IComponent *component)" ]
cppcode += [ "{" ]
cppcode += [ "	nlwarning(\"Unknown IComponent componentUp(component) call\");" ]
cppcode += [ "}" ]
cppcode += [ "" ]
cppcode += [ "void {CLASS}::componentDown(IComponent *component)" ]
cppcode += [ "{" ]
cppcode += [ "	nlwarning(\"Unknown IComponent componentDown(component) call\");" ]
cppcode += [ "}" ]
cppcode += [ "" ]
cppcode += [ "} /* namespace {NAMESPACE} */" ]
cppcode += [ "" ]
