...
#ifndef NL_GAMEEVENTSERVER_H
#define NL_GAMEEVENTSERVER_H
...
}; // END OF CLASS YOURCLASSNAME

}; // END OF NAMESPACE NLEM

#endif // NL_GAMEEVENTSERVER_H
